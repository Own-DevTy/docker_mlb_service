...
export default function House(){
    ...
    const [r_isChecked1, r_setIsChecked1] = useState(false); const [r_isChecked2, r_setIsChecked2] = useState(false);
    const [r_isChecked3, r_setIsChecked3] = useState(false); const [r_isChecked4, r_setIsChecked4] = useState(false); const [r_isChecked5, r_setIsChecked5] = useState(false);
                ...
                <div className={styles.left_plist}>
                    ...
                    <div className={styles.check_box}>
                        <div className={styles.l_check_box}>
                            <input type="checkbox" id="l_player1" name="option" checked={l_isChecked1} onChange={()=> l_handleCheckboxChange(1)}/>
                            ...
                            <input type="checkbox" id="l_player2" name="option" checked={l_isChecked2} onChange={()=> l_handleCheckboxChange(2)}/>
                ...
                <div className={styles.right_plist}>
                    ...
                    <div className={styles.check_box}>
                        <div className={styles.r_check_box}>
                            <input type="checkbox" id="r_player1" name="option" checked={r_isChecked1} onChange={()=> r_handleCheckboxChange(1)}/>
                            <label htmlFor="r_player1">
                                <img className={styles.id_photo} src={`https://img.mlbstatic.com/mlb-photos/image/upload/d_people:generic:headshot:67:current.png/w_213,q_auto:best/v1/people/683002/headshot/67/current`}
                                alt={"404"} height={50} width={50}/>Gunnar Henderson</label><br/>
                            <input type="checkbox" id="r_player2" name="option" checked={r_isChecked2} onChange={()=> r_handleCheckboxChange(2)}/>
